...
% The leader narrative or abstract, if required,1 should be between 75 and 100 words, summarizing the essence of the article ? the technology or method, the results, any conclusions, and impact ? in language that encourages readers to continue reading. The article here describes the essence of the magazine ACM Inroads and the format of all (initial, revisions when applicable, and final) submissions. The editorial office of ACM Inroads will return any submission not following this format. This leader (with dashes) contains 98 words.
