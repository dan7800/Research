...
%%%% DK: I am adding the following related works in based on the recommendations of previous MSR reviewers. I personally don't see them as being all that useful.
...
%% Should I show the LOC and User rating values in the tables?
 \multicolumn{2}{ | c |  }{}  &\multicolumn{3}{ c |   }{\bfseries MWU}    \\ \hline
...
% & LOC & \checkmark &  & .00015  \\ \cline{2-5}
 ...
 & Over-Permissions & X \checkmark X & & X  \\ \cline{2-5}
 & Under-Permissions &  & & X  \\ \cline{2-5}
 & Androrisk Score &  & & X  \\ \hline \hline % \\ \cline{2-5}
...
% End users may not be at all likely to see vulnerabilities
