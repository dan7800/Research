...
% Using JPF to Perform Concolic Analysis on Android Applications
...
Patrick McAfee, Nuthan Munaiah, Samuel~A.~Malachowsky and Daniel~E.~Krutz\\ 	
	\affaddr{Software Engineering Department}\\
       ...
       \email{\{pjm4439, nm6061, samvse, dxkvse\}@rit.edu}
       \alignauthor
...
\keywords{Concolic Analysis, Java PathFinder, Testing, Verification}
...
%% What are other static analysis tools for Android?
%% What are some of their applications? Testing, malware detection etc....
...
\vspace{10mm} %% Used for bumping the title to a new page
...
\begin{figure}[ht!]
\centering
%\frame{\includegraphics[width=0.45\textwidth]{images/instructionsscreenshot.png}}
...
%%%% Todo
%	Look at SAC reviews
%	What are some applications of the tool? How can it be improved?
%	Add another screenshot or two
%	Cite some papers from Java Pathfinder Workshop
%	Give it a JPF title (Most of the other papers in the workshop seem to have a JPF title)



% JPF: https://jpf.byu.edu/jpf-workshop-2016/   == https://jpf.byu.edu/jpf-workshop-2016/cfp.html
% 5 pages max
