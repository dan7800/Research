...
\documentclass{sig-alternate} %%% Using this adds the bottom left info on page 1
...
\conferenceinfo{SAC'17,}{April 3-7, 2017, Marrakech, Morocco}
...
%% Summary notes
\newif\ifisnopsummarynote
%\ifisnoSummaryNote % change to true/false to remove personally identifiable information (pii)
\ifisnopsummarynote % change to true/false to remove personally identifiable information (pii)
...
\caption{Call Stack Similarity Fail to Distinguish Legitimate and Illegal Groups~\label{tab:stack2}}
