 ...
 *  @version Release 2.5.1f - 2004-09-04 13:47:05.447 */
...
{
log.warn("setAttributeName - length > 60 - truncated");
...
{
log.warn("setEventType - length > 2 - truncated");
...
{
log.warn("setNewValue - length > 2000 - truncated");
...
{
log.warn("setOldValue - length > 2000 - truncated");
...
{
log.warn("setTextMsg - length > 2000 - truncated");
...
if (WFState.length() > 2)
{
log.warn("setWFState - length > 2 - truncated");
...
import org.compiere.util.*;
/** Generated Model for AD_WF_EventAudit
 ** @version $Id: X_AD_WF_EventAudit.java,v 1.36 2004/05/20 05:59:12 jjanke Exp $ */
public class X_AD_WF_EventAudit extends PO
{
/** Standard Constructor */
public X_AD_WF_EventAudit (Properties ctx, int AD_WF_EventAudit_ID)
