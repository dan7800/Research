...
public class DoMgtDailySalesReportType01 implements Action
{
	...
	public void fnGetReportType01Values(HttpServlet servlet, HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			...
			// / on a particular day
			Vector vecNaInv = NominalAccountNut.getValueObjectsGiven(pcCenter, naForeignTable, naForeignKey, currency,
					natForeignTable, natForeignKey, tsFrom, tsTo, strOption);
			...
			Vector vecNaRec = NominalAccountNut.getValueObjectsGiven(pcCenter, naForeignTable, naForeignKey, currency,
					natForeignTable, natForeignKey, tsFrom, tsTo, strOption);
...
} // end of class DoMgtDailySalesReportType01
/*==========================================================
 *
 * Copyright  of Vincent Lee. All Rights Reserved.
 * (http://www.vlee.net)
