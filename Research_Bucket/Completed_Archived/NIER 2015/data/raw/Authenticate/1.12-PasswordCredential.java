...
public class PasswordCredential  implements java.io.Serializable {
    ...
    private java.lang.Boolean encryptedCredential;
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PasswordCredential)) return false;
    ...
    public synchronized int hashCode() {
        ...
        if (getEncryptedCredential() != null) {
            _hashCode += getEncryptedCredential().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PasswordCredential.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://authentication.integration.crowd.atlassian.com", "PasswordCredential"));
        ...
        elemField.setFieldName("encryptedCredential");
        elemField.setXmlName(new javax.xml.namespace.QName("http://authentication.integration.crowd.atlassian.com", "encryptedCredential"));
