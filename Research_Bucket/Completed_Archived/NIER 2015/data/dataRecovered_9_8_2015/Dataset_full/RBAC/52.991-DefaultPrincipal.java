...
---------------------------------------------------------------------*/
/*.IA,	PUBLIC Include File DefaultPrincipal.java			*/
 ...
 * @version $Id: DefaultPrincipal.java,v 1.1 2002/04/14 20:20:06 awtopensource Exp $
 */

public abstract class DefaultPrincipal  implements Principal {

	/****/
	private SecurityRealm	fSecurityRealm;
    ...
    /****/
    public DefaultPrincipal(SecurityRealm realm, 
							String identifier, 
                            byte[] credentials,
                            Identity[] identitys,
                            Group[] groups,
