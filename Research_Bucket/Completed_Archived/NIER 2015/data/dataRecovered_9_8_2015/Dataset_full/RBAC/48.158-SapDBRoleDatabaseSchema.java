 ...
 * 
 * $Id: SapDBRoleDatabaseSchema.java,v 1.20 2009/04/22 06:29:35 bastafidli Exp $
 * 
...
package org.opensubsystems.security.persist.db.sapdb;
...
/**
 * Database specific operations related to persistence of roles in SapDB.
 *
 * @version $Id: SapDBRoleDatabaseSchema.java,v 1.20 2009/04/22 06:29:35 bastafidli Exp $
 * @author Miro Halas
 * @code.reviewer Miro Halas
 * @code.reviewed Initial revision
 */
public class SapDBRoleDatabaseSchema extends RoleDatabaseSchema
{   
   /*
      ...
      create dbprocedure INSERT_BF_ROLE 
      (
      ...
      TRY 
         ...
         SET OUT_KEY = " + strUserName + ".BF_ROLE.CURRVAL;
      CATCH
         IF $RC <> 0 THEN STOP ($RC, $ERRMSG);

      create dbprocedure UPDATE_BF_ROLE 
      (
         IN IN_NAME VARCHAR(50),
         IN IN_DESCRIPTION VARCHAR(1024),
         IN IN_ENABLED INTEGER,
      ...
      TRY
         SET OUT_TIMESTAMP = now();
         IF (IN_UNMODIFIABLE = 1) THEN BEGIN
      ...
      (
        ...
        create dbprocedure INSERT_BF_ACCESS_RIGHT 
        (
           IN IN_ROLE_ID INTEGER,
           IN IN_DOMAIN_ID INTEGER,
        ...
        TRY
           ...
           INSERT INTO " + strUserName + ".BF_ACCESS_RIGHT(ROLE_ID, DOMAIN_ID, 
              ...
              :OUT_TIMESTAMP);
           SET OUT_KEY = " + strUserName + ".BF_ACCESS_RIGHT.CURRVAL;
        CATCH
           IF $RC <> 0 THEN STOP ($RC, $ERRMSG);
   ...
   */
    ...
    */
   private static Logger s_logger = Log.getInstance(SapDBRoleDatabaseSchema.class);
    ...
    */
   public SapDBRoleDatabaseSchema(
   ) throws OSSException
   {
      super();
   ...
   ) throws SQLException, OSSException
   {
      ...
      {        
         ...
         if (stmQuery.execute(
            "create dbprocedure INSERT_" + ACCESSRIGHT_TABLE_NAME + NL +
            "(" + NL +
            ...
            "      :OUT_TIMESTAMP);" + NL +
            "   SET OUT_KEY = " + strUserName + "." + ACCESSRIGHT_TABLE_NAME + ".CURRVAL;" + NL +
            "CATCH" + NL +
            "   IF $RC <> 0 THEN STOP ($RC, $ERRMSG);"))
         {
            // Close any results
   ...
   {
      if (stmQuery.execute(
         "create dbprocedure INSERT_" + ROLE_TABLE_NAME + NL +
         "(" + NL +
         "   IN IN_DOMAIN_ID INTEGER," + NL +         
         ...
         "   SET OUT_KEY = " + strUserName + "." + ROLE_TABLE_NAME + ".CURRVAL;" + NL +
         "CATCH" + NL +
         "   IF $RC <> 0 THEN STOP ($RC, $ERRMSG);"))
      {
         // Close any results
   ...
   {
      if (stmQuery.execute(
         "create dbprocedure UPDATE_" + ROLE_TABLE_NAME + NL +
         "(" + NL +
         "   IN IN_NAME VARCHAR(" + ROLE_NAME_MAXLENGTH + ")," + NL +
         "   IN IN_DESCRIPTION VARCHAR(" + ROLE_DESCRIPTION_MAXLENGTH + ")," + NL +
         "   IN IN_ENABLED INTEGER," + NL +
         ...
         "TRY" + NL +
         "   SET OUT_TIMESTAMP = now();" + NL +
         "   IF (IN_UNMODIFIABLE = 1) THEN BEGIN" + NL +
