...
import org.apache.directory.triplesec.admin.Constants;
...
import org.apache.directory.triplesec.admin.HauskeysUser;
import org.apache.directory.triplesec.admin.HauskeysUserModifier;
import org.apache.directory.triplesec.admin.LocalUser;
import org.apache.directory.triplesec.admin.LocalUserModifier;
import org.apache.directory.triplesec.admin.NoSuchEntryException;
import org.apache.directory.triplesec.admin.Permission;
import org.apache.directory.triplesec.admin.PermissionModifier;
...
public class IntegrationTest extends TriplesecIntegration
{
    ...
    public void testHauskeysUserDao() throws Exception
    {
        ...
        modifier.setAddress1( "address1" ).setAddress2( "address2" ).setCity( "city" ).
        setCompany( "company" ).setCountry( "country" ).setStateProvRegion( "stateProvRegion" )
        .setZipPostalCode( "zipPostalCode" ).setLabel( "testHauskeysUser" ).setNotifyBy( "sms" )
