        ...
        if (connectorProp.properties != null && connectorProp.properties.size() > 0) {
            ...
            try {
                ...
                while (i.hasNext()) {
                    ...
                    // Begin neogia specific : URIEncoding is not take in account by setProperty method. Need to be reported to Ofbiz
                    if ("URIEncoding".equals(prop.name)) {
                        connector.setURIEncoding(prop.value);
                    }
                    // End neogia specific : URIEncoding is not take in account by setProperty method. Need to be reported to Ofbiz
