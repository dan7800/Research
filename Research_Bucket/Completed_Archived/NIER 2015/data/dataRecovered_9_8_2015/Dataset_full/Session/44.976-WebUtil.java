 ...
 *
 *  @author Jorg Janke
 *  @version  $Id: WebUtil.java,v 1.1 2004/08/30 06:00:11 jjanke Exp $
 */
public final class WebUtil
{
	/**	Static Logger	*/
	private static Logger	s_log	= Logger.getCLogger (WebUtil.class);
	...
	public static script getClearFrame (String target)
	{
		...
		cmd.append("d.open();\n");
		cmd.append("d.write('<link href=\"").append(WebEnv.getStylesheetURL()).append("\" rel=\"stylesheet\">');\n");
		cmd.append("d.close();");
		//
