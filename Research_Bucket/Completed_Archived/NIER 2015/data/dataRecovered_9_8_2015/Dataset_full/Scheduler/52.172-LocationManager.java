...
public class LocationManager implements AgillaConstants {
	...
	public final static boolean ENABLE_CLUSTERING = edu.wustl.mobilab.agilla.AgillaProperties.enableClustering();	// indicates whethering clustering is enabled
	...
	class QueryAgentLocMsgHandler implements QueryHandler, MessageListenerJ 
	{
		 ...
		 * @see edu.wustl.mobilab.agilla.LocationManager.QueryHandler#sendReply(edu.wustl.mobilab.agilla.LocationManager.Query)
		 */
