/*
  $Id: SearchExecutor.java 296 2009-07-01 15:12:00Z dfisher $
 ...
 *
 * @author  Middleware Services
 * @version  $Revision: 296 $ $Date: 2009-07-01 08:12:00 -0700 (Wed, 01 Jul 2009) $
 */
...
public class SearchExecutor
{
    ...
    throws PeopleSearchException
  {
    ...
    if (query.getFromResult() != null) {
      if (query.getToResult() != null) {
        if (
          query.getFromResult().intValue() <=
            query.getToResult().intValue()) {
          i = m.subMap(query.getFromResult(), query.getToResult()).values()
              .iterator();
        }
      } else {
   ...
   */
  private void processResults(final QueryResult queryResult)
    throws PeopleSearchException
  {
  ...
  private String buildLdapQuery(
    final String query,
    final String dynamicRestrictions)
  {
    String search = null;
    if (query != null) {
