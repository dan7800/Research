...
public class GenericDelegator implements DelegatorInterface {
        ...
        if (delegator == null) {
            synchronized (GenericDelegator.class) {
                ...
                if (delegator == null) {
                    ...
                    try {
                        // Begin neogia specific : use neogia delegator instead of default one
                        /*
                        delegator = new GenericDelegator(delegatorName);
                        */
                        delegator = new NeogiaDelegator(delegatorName);
                        // End neogia specific : use neogia delegator instead of default one
   ...
   /** Store a group of values
    ...
    public GenericDelegator cloneDelegator(String delegatorName) {
        ...
        */
        GenericDelegator newDelegator = new NeogiaDelegator();
        // End neogia specific : use neogia delegator instead of default one
