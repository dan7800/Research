...
- How was jLint calculated and other averages were created

%\begin{table*}[t]
%\centering
%\caption{Effect of Version Information}
%\label{Table:versionaffect}
%  \begin{tabular}{ l | l | l | l |  l | l | l | l | l }
%    \bfseries Group  & \bfseries AppCount  & \bfseries UserRating & \bfseries Jlint & \bfseries Defect & \bfseries F-Risk & \bfseries Code Clones & \bfseries OverPrivCount & \bfseries Class Files \\ \hline
%    0 & x & x & x  & x  & x  & x  & x  & x \\ \hline
 %   1 & x & x & x  & x  & x  & x  & x  & x \\ \hline
%    2 & x & x & x  & x  & x  & x  & x  & x \\ \hline
 %   3 & x & x & x  & x  & x  & x  & x  & x \\ \hline
 %   4 & x & x & x  & x  & x  & x  & x  & x \\ \hline
 %   5 & x & x & x  & x  & x  & x  & x  & x \\ \hline
 %   6 & x & x & x  & x  & x  & x  & x  & x \\ \hline
 %   7 & x & x & x  & x  & x  & x  & x  & x \\ 
 % \end{tabular}
%\end{table*}
...
% Clones
%\addplot [color=black,dotted,mark=*,mark options={solid},smooth] plot coordinates {(0,1) (1,2) (2,3) (3,4) (4,3) (5,2)(6,1)(7,0)};
%\addlegendentry{Clones}
