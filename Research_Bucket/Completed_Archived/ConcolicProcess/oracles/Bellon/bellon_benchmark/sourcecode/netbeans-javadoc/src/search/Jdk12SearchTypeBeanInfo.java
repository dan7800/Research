...
public class Jdk12SearchTypeBeanInfo extends SimpleBeanInfo {    
    ...
    public BeanDescriptor getBeanDescriptor () {
        ...
        descr.setName(ResourceUtils.getBundledString("PROP_Jdk12SearchType")); // NOI18N
    ...
    public PropertyDescriptor[] getPropertyDescriptors () {
        ...
        try {
            desc = new PropertyDescriptor[]{
                    new PropertyDescriptor("caseSensitive", Jdk12SearchType.class) //0 // NOI18N
            };
