...
/** BeanInfo for StdDoclet
 * @author Petr Suchomel
 */
public class StdDocletTypeBeanInfo extends SimpleBeanInfo {
    public BeanDescriptor getBeanDescriptor () {
        BeanDescriptor descr = new BeanDescriptor (org.netbeans.modules.javadoc.JavadocType.class);        
        descr.setDisplayName (ResourceUtils.getBundledString("CTL_StdDoclet"));   //NOI18N
        descr.setShortDescription (ResourceUtils.getBundledString("HINT_StdDoclet"));   //NOI18N
