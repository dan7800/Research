...
test:
       ...
       flglobal = fopen("global.dbg","r");
       flunitinfo = fopen("unitinfo.dbg","r");
       flprecinfo = fopen("precinfo.dbg","r");
       floffice = fopen("offices.dbg","r");
       floffnam = fopen("offnam.dbg","r");
       fldualoff = fopen("dualoff.dbg","r");
       flcand = fopen("candidat.dbg","r");
       fldualcand = fopen("dualcand.dbg","r");
