...
# 482 "/usr/include/sys/fcntl.h" 3 4

int open(const char *, int, ...) __asm("_" "open" );
int creat(const char *, mode_t) __asm("_" "creat" );
int fcntl(int, int, ...) __asm("_" "fcntl" );
# 502 "/usr/include/sys/fcntl.h" 3 4
...
all_ins(PyObject* d)
{
        if (ins(d, "LOCK_SH", (long)1)) return -1;
        if (ins(d, "LOCK_EX", (long)2)) return -1;
        if (ins(d, "LOCK_NB", (long)4)) return -1;
        if (ins(d, "LOCK_UN", (long)8)) return -1;
# 449 "fcntlmodule.c"
...
initfcntl(void)
{
 ...
 m = Py_InitModule4_64("fcntl", fcntl_methods, module_doc, (PyObject *)((void *)0), 1013);
 if (m == ((void *)0))
  return;
