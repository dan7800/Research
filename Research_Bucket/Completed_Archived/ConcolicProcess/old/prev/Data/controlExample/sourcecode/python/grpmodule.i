...
# 128 "/usr/include/i386/types.h" 3 4
...
mkgrent(struct group *p)
{
    ...
    if ((w = PyList_New(0)) == ((void *)0)) {
        if ( --(v)->ob_refcnt != 0) ; else ( (*((PyObject *)(v))->ob_type->tp_dealloc)((PyObject *)((PyObject *)(v))));
        return ((void *)0);
    }
    for (member = p->gr_mem; *member != ((void *)0); member++) {
        PyObject *x = PyString_FromString(*member);
        if (x == ((void *)0) || PyList_Append(w, x) != 0) {
            if ((x) == ((void *)0)) ; else if ( --(x)->ob_refcnt != 0) ; else ( (*((PyObject *)(x))->ob_type->tp_dealloc)((PyObject *)((PyObject *)(x))));
            if ( --(w)->ob_refcnt != 0) ; else ( (*((PyObject *)(w))->ob_type->tp_dealloc)((PyObject *)((PyObject *)(w))));
            if ( --(v)->ob_refcnt != 0) ; else ( (*((PyObject *)(v))->ob_type->tp_dealloc)((PyObject *)((PyObject *)(v))));
            return ((void *)0);
        }
        if ( --(x)->ob_refcnt != 0) ; else ( (*((PyObject *)(x))->ob_type->tp_dealloc)((PyObject *)((PyObject *)(x))));
    }


    (((PyStructSequence *)(v))->ob_item[setIndex++] = PyString_FromString(p->gr_name));




    if (p->gr_passwd)
     (((PyStructSequence *)(v))->ob_item[setIndex++] = PyString_FromString(p->gr_passwd));
    else {
     (((PyStructSequence *)(v))->ob_item[setIndex++] = (&_Py_NoneStruct));
     ( ((&_Py_NoneStruct))->ob_refcnt++);
    }

    (((PyStructSequence *)(v))->ob_item[setIndex++] = PyInt_FromLong((long) p->gr_gid));
    (((PyStructSequence *)(v))->ob_item[setIndex++] = w);
...
grp_getgrgid(PyObject *self, PyObject *pyo_id)
{
    ...
    if (!py_int_id)
     return ((void *)0);
    gid = (((PyIntObject *)(py_int_id))->ob_ival);
    if ( --(py_int_id)->ob_refcnt != 0) ; else ( (*((PyObject *)(py_int_id))->ob_type->tp_dealloc)((PyObject *)((PyObject *)(py_int_id))));
...
grp_getgrnam(PyObject *self, PyObject *pyo_name)
{
    ...
    if (!py_str_name)
     return ((void *)0);
    name = (((PyStringObject *)(py_str_name))->ob_sval);

    if ((p = getgrnam(name)) == ((void *)0)) {
 PyErr_Format(PyExc_KeyError, "getgrnam(): name not found: %s", name);
 if ( --(py_str_name)->ob_refcnt != 0) ; else ( (*((PyObject *)(py_str_name))->ob_type->tp_dealloc)((PyObject *)((PyObject *)(py_str_name))));
        return ((void *)0);
    }
...
grp_getgrall(PyObject *self, PyObject *ignore)
{
    ...
    while ((p = getgrent()) != ((void *)0)) {
        ...
        if (v == ((void *)0) || PyList_Append(d, v) != 0) {
            if ((v) == ((void *)0)) ; else if ( --(v)->ob_refcnt != 0) ; else ( (*((PyObject *)(v))->ob_type->tp_dealloc)((PyObject *)((PyObject *)(v))));
            if ( --(d)->ob_refcnt != 0) ; else ( (*((PyObject *)(d))->ob_type->tp_dealloc)((PyObject *)((PyObject *)(d))));
            return ((void *)0);
        }
        if ( --(v)->ob_refcnt != 0) ; else ( (*((PyObject *)(v))->ob_type->tp_dealloc)((PyObject *)((PyObject *)(v))));
    }
...
{
    PyObject *m, *d;
    m = Py_InitModule4_64("grp", grp_methods, grp__doc__, (PyObject *)((void *)0), 1013);
    if (m == ((void *)0))
        return;
