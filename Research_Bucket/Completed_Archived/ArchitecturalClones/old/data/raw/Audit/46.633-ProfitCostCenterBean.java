...
public class ProfitCostCenterBean implements EntityBean
{
	...
	// members ----------------------------------------------
	/*
	 * private Integer mProfitCostCenterId; //primary key!!! private String
	 * mProfitCostCenterCode; private Integer mBizUnitId; private String mName;
	 * private String mDescription; private String mStatus; private Timestamp
	 * mLastUpdateTime; private Integer mUserIdEdit;
	 */
	...
	/*
	 * public Integer ejbCreate(String strPCCode, String strName, String
	 * strDesc, Integer intBizUnit, Timestamp tsLastUpdate, Integer
	 * intUserIdCreate)
	 */
	public Integer ejbCreate(ProfitCostCenterObject newObj) throws CreateException
	{
		...
		try
		{
			// pkid = insertNewRow(strPCCode,intBizUnit, strName,
			// strDesc, tsLastUpdate, intUserIdCreate);
	...
	// public void ejbPostCreate(String strPCCode,
	// String strName, String strDesc,
	// Integer intBizUnit, Timestamp tsLastUpdate,
	// Integer intUserIdCreate)
	// { }
	...
	// private Integer insertNewRow(String strPCCode,
	// Integer intBizUnit, String strName,
	// String strDesc, Timestamp tsLastUpdate,
	// Integer intUserIdCreate)
	private Integer insertNewRow(ProfitCostCenterObject newObj) throws SQLException
	{
		...
		String insertStatement = "insert into " + TABLENAME + " (pccenterid , pccentercode, bizunitid,  "
				+ " name , description , " + " status , lastupdate , userid_edit, fullname, currency ) "
				+ " values ( ?, ? , ? , ? ,? ,?, ?, ?, ?, ? )";
	...
	private Vector selectAllValueObjects() throws SQLException
	{
		...
		makeConnection();
		String selectStmt = "SELECT " + TABLENAME + "." + PKID + ", " + TABLENAME + "." + NAME
				+ ", acc_bizunit_index.name, acc_bizentity_index.name FROM " + TABLENAME
				+ ", acc_bizunit_index, acc_bizentity_index WHERE " + TABLENAME + "." + BIZ_UNIT_ID
				+ " = acc_bizunit_index.pkid AND " + "acc_bizunit_index.bizentityid = acc_bizentity_index.pkid AND "
				+ TABLENAME + "." + STATUS + " = ? ORDER BY acc_bizentity_index.bizentitycode";
			...
			throws SQLException
	{
		...
		selectStmt += " ORDER BY " + BIZ_UNIT_ID + ", " + PKID + " ";
		PreparedStatement prepStmt = con.prepareStatement(selectStmt);
	...
	{
		makeConnection();
		String updateStatement = "update " + TABLENAME + " set pccenterid = ? , " + " pccentercode =  ? , "
				+ " bizunitid = ? , " + " name = ? , " + " description = ? , " + " status = ? , "
				+ " lastupdate = ? , " + " userid_edit = ?,   " + " fullname = ?,   " + " currency = ?  "
				+ " where pccenterid = ?;";
