...
public class DoMgtGrossProfitByDepartmentDetails implements Action
{
	String strClassName = "DoMgtGrossProfitByDepartmentDetails";
			...
			throws java.io.IOException, javax.servlet.ServletException
	{
		...
		if (formName == null)
		{
			return new ActionRouter("mgt-gross-profit-by-department-details-page");
		}
		
		if (formName.equals("popupPrint"))
		{
			return new ActionRouter("mgt-gross-profit-by-department-details-print-page");
		}
	...
	public void fnGenerateReport(HttpServlet servlet, HttpServletRequest req, HttpServletResponse res) throws Exception
	{
		...
		GrossProfitByDepartmentDetailsForm gpdd = (GrossProfitByDepartmentDetailsForm) session.getAttribute("mgt-gross-profit-by-department-details-report");
		
		try
		{
			if (gpdd == null)
			{
				gpdd = new GrossProfitByDepartmentDetailsForm();
				session.setAttribute("mgt-gross-profit-by-department-details-report",gpdd);
			}
	...
	private void fnAuditTrail(HttpServlet servlet, HttpServletRequest req, HttpServletResponse res)
	{
		...
		GrossProfitByDepartmentDetailsForm gpdd = (GrossProfitByDepartmentDetailsForm) 
												session.getAttribute("mgt-gross-profit-by-department-details-report");
		...
		if (iUserId != null)
		{
			...
			atObj.remarks = "generate-rpt: Gross Profit by Department Details";
