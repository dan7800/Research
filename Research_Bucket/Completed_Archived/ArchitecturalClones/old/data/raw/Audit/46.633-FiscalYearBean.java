...
public class FiscalYearBean implements EntityBean
{
	...
	public Integer ejbCreate(Integer fiscalYear, String beginMonth, String endMonth, String status)
	...
	private Integer insertNewRow(Integer fiscalYear, String beginMonth, String endMonth, String status)
	{
		...
		try
		{
			...
			String sqlStatement = "INSERT INTO " + TABLENAME
					+ " (pkid, fiscalyear, beginmonth, endmonth, status) VALUES (?, ?, ?, ?, ?)";
			cn = ds.getConnection();
	...
	private void loadObject()
	{
		...
		try
		{
			String sqlStatement = "SELECT pkid, fiscalyear, beginmonth, endmonth, status FROM " + TABLENAME
					+ " WHERE pkid = ?";
			cn = ds.getConnection();
			ps = cn.prepareStatement(sqlStatement);
	...
	private void storeObject()
	{
		...
		try
		{
			String sqlStatement = "UPDATE " + TABLENAME
					+ " SET fiscalyear = ?, beginmonth = ?, endmonth = ?, status = ? WHERE pkid = ?";
			cn = ds.getConnection();
			ps = cn.prepareStatement(sqlStatement);
	...
	private Vector selectValueObjectsGiven(String fieldName1, String value1, String fieldName2, String value2)
	{
		...
		try
		{
			String sqlStatement = "SELECT pkid, fiscalyear, beginmonth, endmonth, status FROM " + TABLENAME + " WHERE "
					+ fieldName1 + " = ? ORDER BY fiscalyear, beginmonth, endmonth, pkid ";
